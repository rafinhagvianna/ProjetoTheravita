...
public class GenFuncionario {
    ...
    public static void cadastrarFuncionario(ArrayList<Setor> setores){
    ...
    public static void listarFuncionariosPorSetor(ArrayList<Setor> setores){
        Scanner sc = new Scanner(System.in);
        System.out.println("Escolha o setor para o funcionário:");
        for (int i = 0; i < setores.size(); i++) {
            System.out.println((i + 1) + " - " + setores.get(i).getNome());
    ...
    public static void editarFuncionario(Funcionario funcionarioEditar, ArrayList<Setor> setores){
        Scanner sc = new Scanner(System.in);
        int opc;
    ...
    public static void excluirFuncionario(ArrayList<Funcionario> funcionarios){
        Scanner sc = new Scanner(System.in);
