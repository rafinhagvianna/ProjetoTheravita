...
public class GenProduto {
    ...
    public static void atualizarProduto(ArrayList<Produto> produtos) {
    ...
    public static void diponibilidadeProduto(ArrayList<Produto> produtos) {
